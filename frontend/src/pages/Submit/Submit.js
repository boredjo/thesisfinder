...
const Submit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    ideasData.push(newIdea); // Append the new idea to the loaded ideasData

    localStorage.setItem('ideasData', JSON.stringify(ideasData)); // Store the updated ideasData to localStorage
